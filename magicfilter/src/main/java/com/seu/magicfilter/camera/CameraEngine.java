    ...
    public static boolean openCamera(int id){
        if(camera == null){
            try{
                ...
                if (MagicParams.previewCallback != null) {
                    camera.setPreviewCallback(MagicParams.previewCallback);
                }
                return true;
            }catch(RuntimeException e){
                return false;
...
//    }
    ...
    private static void setDefaultParameters(){
        ...
        if (MagicParams.cameraPreviewSize != null) {
            parameters.setPreviewSize(MagicParams.cameraPreviewSize.getWidth(), MagicParams.cameraPreviewSize.getHeight());
        }
        ...
        if (MagicParams.cameraPictureSize != null) {
            parameters.setPictureSize(MagicParams.cameraPictureSize.getWidth(), MagicParams.cameraPictureSize.getHeight());
        }
    ...
    public static void startPreview(SurfaceTexture surfaceTexture){
        if(camera != null)
            try {
                ...
                // TODO optimize display orientation
