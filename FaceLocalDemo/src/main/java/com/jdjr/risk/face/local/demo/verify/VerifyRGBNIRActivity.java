...
public class VerifyRGBNIRActivity extends Activity {
...
//    private ImageView mCameraImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verify_rgbnir);
...
//    }
    ...
    public void initVerify(View view) {
//        initFaceVerify();
    
    }
    
    public void releaseVerify(View view) {
    
//        FaceCameraManager.getInstance().releaseFaceCamera();
...
//    private static ExecutorService DISPLAY_SERVICE = Executors.newSingleThreadExecutor();
    
//    private void displayCameraImage(final byte[] frame) {
//        DISPLAY_SERVICE.submit(new Runnable() {
//            @Override
//            public void run() {
//                // final Bitmap bitmap = BitmapFactory.decodeByteArray(frame, 0, frame.length);
//
//                final Bitmap bitmap = decodeYUV(frame);
//
//                new Handler(Looper.getMainLooper()).post(new Runnable() {
//                    @Override
//                    public void run() {
//                        // Log.d("FaceLocalCamera", ".............. displayCameraImage bitmap = " + bitmap);
    ...
    private final FaceFrameManager.BasePropertyCallback mBasePropertyCallback = new FaceFrameManager.BasePropertyCallback() {
        ...
        public void onBasePropertyResult(List<DetectFaceInfo> faceBoxList) {
            if (faceBoxList != null && faceBoxList.size() > 0) {
                VerifyRGBNIRActivity.this.onFaceResult(faceBoxList);
            } else {
                onFaceLost();
            }
