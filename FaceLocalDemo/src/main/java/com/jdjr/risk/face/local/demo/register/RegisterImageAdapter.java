...
public class RegisterImageAdapter extends RecyclerView.Adapter<RegisterImageAdapter.ImageHolder> {
...
//    }
    ...
    public RegisterImageAdapter(ArrayList<RegisterImage> registerImages, SelectListener listener) {
    ...
    @Override
    public RegisterImageAdapter.ImageHolder onCreateViewHolder( ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final RegisterImageAdapter.ImageHolder holder, int position) {
