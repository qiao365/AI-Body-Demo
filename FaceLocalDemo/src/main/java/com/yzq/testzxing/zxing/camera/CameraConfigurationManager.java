...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		final int previewWidth = display.getWidth();
		final int previewHeight = display.getHeight();
		
		Log.d("FaceLocalActive", "............. previewWidth = " + previewWidth);
		Log.d("FaceLocalActive", "............. previewHeight = " + previewHeight);
...
//		final int previewHeight = PreviewSize.HEIGHT;
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode) {
		...
		Log.d("FaceLocalActive", "............. cameraResolution.x = " + cameraResolution.x);
		Log.d("FaceLocalActive", "............. cameraResolution.y = " + cameraResolution.y);
