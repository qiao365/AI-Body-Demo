...
import com.jdjr.risk.face.local.demo.camera.CameraType;
...
public final class CameraManager {
	...
	public synchronized void openDriver(SurfaceHolder holder)
			throws IOException {
		Log.d("FaceLocalActive", ".......... CameraManager openDriver");
		Camera theCamera = camera;
		if (theCamera == null) {
			Log.d("FaceLocalActive", ".......... CameraManager requestedCameraId = " + requestedCameraId);
			if (requestedCameraId >= 0) {
				// theCamera = OpenCameraInterface.open(requestedCameraId);
				theCamera = OpenCameraInterface.open(CameraType.getRGB());
			} else {
				theCamera = OpenCameraInterface.open(CameraType.getRGB());
			}
...
//			Log.d("FaceLocalActive", "........... rect.left = " + rect.left);
//			Log.d("FaceLocalActive", "........... rect.right = " + rect.right);
//			Log.d("FaceLocalActive", "........... rect.top = " + rect.top);
//			Log.d("FaceLocalActive", "........... rect.bottom = " + rect.bottom);
